...
library(kernlab)
donnees.sc = specc(donnees[, -habillage], centers = 3)


# 7. Quel nombre de classes peut-on proposer ? 3
K = 3
...
# ARI
adjustedRandIndex(donnees$donnees.y, donnees.mclust$classification) # 0.1141917
